...
window.onload = function() {
  ...
  const firebaseConfig = {
    ...
    databaseURL: "https://chat-app-dpst-default-rtdb.asia-southeast1.firebasedatabase.app",
    projectId: "chat-app-dpst",
    storageBucket: "chat-app-dpst.appspot.com",
  ...
  class MEME_CHAT{
    ...
    create_title(){
      ...
      title.textContent = 'THE BOYS CHAT 2.0'
